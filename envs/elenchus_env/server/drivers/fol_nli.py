...
--------------------------
FOLNLIDriver — tasks from the FOL-NLI dataset (tasksource/FOL-nli).

82K theorem-prover-verified NLI problems.
Three classes: entailment / contradiction / neutral.
...
RULE_TEXT = (
    ...
    "Some premises are facts; others are logical rules (conditional or universal). "
...
class FOLNLIDriver(BaseDriver):
    """Driver for the FOL-NLI formal logic NLI dataset (theorem-prover verified)."""
